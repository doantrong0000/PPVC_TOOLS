...
{
    public class ReloadRebarProperty : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ReloadRebarProperty()
          : base("Apply Tekla rebar properties", "Apply rebar properties",
              "Apply rebar properties",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Tekla rebar properties", "rebar properties", "add a Tekla rebar property", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            string macroName = "Drawing symbol 1";
            string rebarProperty = string.Empty;
           


            // Load values from inputs into those variables
         
            if (!DA.GetData(0, ref rebarProperty)) return;
                ...
                @"namespace UserMacros {" + "\r\n" +
                    @"public sealed class Macro {" + "\r\n" +
                        ...
                        @"public static void Run(Tekla.Macros.Runtime.IMacroRuntime runtime) {" + "\r\n" +
                            ...
                            @"akit.ValueChange(""rebar_dim_dial"", ""gr_dim_get_menu"", " + "\"" + rebarProperty + "\"" + ");" + "\r\n" +
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.rebar_dim;
        ...
        {
            get { return new Guid("BE302780-32E0-4A7C-B591-550A8BE59238"); }
        }
    }
}