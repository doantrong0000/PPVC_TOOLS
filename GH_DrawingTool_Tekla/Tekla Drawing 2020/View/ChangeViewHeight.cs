...
{
    public class ChangeViewHeight : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ChangeViewHeight()
          : base("Change view height", "change view height",
              "change view height",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Max view height", "max height", "add max height", GH_ParamAccess.item);
            pManager.AddNumberParameter("Min view height", "min height", "add min height", GH_ParamAccess.item);        
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(1, ref maxHeight)) return;
            ...
            sel_view.RestrictionBox.MaxPoint.Y = maxHeight;
            sel_view.RestrictionBox.MinPoint.Y = minHeight * -1;
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.view_height;
        ...
        {
            get { return new Guid("00F1AC8A-1B14-49E0-3B10-8AB9DDFEDD68"); }
        }
    }
}