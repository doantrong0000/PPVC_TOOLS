...
{
    public class RotateView : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public RotateView()
          : base("Rotate view", "rotate view",
              "rotate view",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Rotation angle", "rotation angle", "add a rotation angle", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            sel_view.RotateViewOnDrawingPlane(rotationAngle);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.rotate_view;
        ...
        {
            get { return new Guid("00F1AC8A-1B14-49E0-3B10-8AB8DDFEDD68"); }
        }
    }
}