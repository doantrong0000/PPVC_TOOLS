...
{
    public class GetFilteredDwgRebarByPrefix : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public GetFilteredDwgRebarByPrefix()
        ...
        {
            pManager.AddTextParameter("Prefix of rebar groups", "rebar group prefix", "add the rebar group prefix", GH_ParamAccess.item);
        ...
        {
            pManager.Register_GenericParam("Filtered model rebar arraylist", "filtered drawing rebar list", "the filtered drawing rebar just got", GH_ParamAccess.item);
            pManager.Register_GenericParam("Filtered drawing rebar arraylist", "filtered model rebar list", "the filtered model rebar just got", GH_ParamAccess.item);
        }
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(0, ref rebarPrefix)) return;
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.rebar_prefix;
        ...
        {
            get { return new Guid("59D3CBDA-468F-4D55-AB88-2CF8D948A470"); }
        }
    }
}